...
export function InteractiveMap({
  ...
  const filteredInstallations = militaryInstallations.filter(
    (installation) =>
      filterBranch === "all" || installation.branch === filterBranch
  );
        ...
        <div className="flex flex-col items-center justify-center w-full h-full">
          <div className="p-6 text-center bg-white rounded-lg shadow-md">
            ...
            <p className="mb-4 text-gray-600">
              This is a placeholder for the interactive map. In the actual
              implementation, this would be a Leaflet map showing military
            ...
            <p className="text-sm text-gray-500">
              {filteredInstallations.length > 4
                ? `+ ${filteredInstallations.length - 4} more installations`
                : ""}
            </p>
          </div>
        </div>
